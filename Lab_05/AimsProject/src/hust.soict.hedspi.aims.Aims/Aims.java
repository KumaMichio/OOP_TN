...
public class Aims {
	...
	public static void main(String[] args) throws PlayerException {
        ...
        private static void handleViewStore(Scanner scanner) throws PlayerException {
            System.out.println("\nStore Items:");
            store.getItems();
            int choice;
            do {
        ...
        private static void handleMediaDetails(Scanner scanner) throws PlayerException {
        ...
        private static void handlePlayMedia(Scanner scanner) throws PlayerException {
            System.out.print("Enter the title of the media: ");
            String title = scanner.nextLine();
            Media media = store.searchByTitle(title);
            if (media == null) {
        ...
        private static void handleViewCart(Scanner scanner) throws PlayerException {
            System.out.println("\nCurrent Cart:");
            cart.displayCart();
            int choice;
            do {
